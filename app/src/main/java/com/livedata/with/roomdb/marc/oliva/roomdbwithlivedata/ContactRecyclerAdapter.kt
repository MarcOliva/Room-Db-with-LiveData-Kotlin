 ...
 */
class ContactRecyclerAdapter : RecyclerView.Adapter<ContactRecyclerAdapter.RecyclerViewHolder>() {

    private var listContacts: List<Contact>? = null
    fun ContactRecyclerAdapter(contacts: List<Contact>) {
